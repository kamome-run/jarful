...
import dev.kusha.ui.theme.KushaColors
...
private fun DrawScope.drawPaperBall(center: Offset, r: Float, rotation: Float) {
    drawCircle(KushaColors.PaperBallShade, r, center + Offset(2f, 3f))
    drawCircle(KushaColors.PaperBall, r, center)
    ...
    for (k in 0 until n) {
        ...
        drawLine(KushaColors.PaperBallShade, Offset(cx - dx, cy - dy), Offset(cx + dx, cy + dy), strokeWidth = 1.5f)
    }
