...
private val Light = lightColorScheme(
    primary = KushaColors.StickyDeep,
    onPrimary = Color.White,
    primaryContainer = KushaColors.Sticky,
    onPrimaryContainer = KushaColors.Ink,
    secondary = KushaColors.Mint,
    onSecondary = Color.White,
    secondaryContainer = KushaColors.MintSoft,
    onSecondaryContainer = Color(0xFF0D3B26),
    tertiary = KushaColors.Jar,
    background = KushaColors.Paper,
    onBackground = KushaColors.Ink,
    surface = Color.White,
    onSurface = KushaColors.Ink,
    surfaceVariant = Color(0xFFF1EBDD),
    onSurfaceVariant = Color(0xFF5B5446),
    error = KushaColors.Coral,
    outline = Color(0xFFCFC6B2),
)

private val Dark = darkColorScheme(
    primary = KushaColors.Sticky,
    onPrimary = KushaColors.Ink,
    primaryContainer = Color(0xFF5A4400),
    onPrimaryContainer = KushaColors.Sticky,
    secondary = Color(0xFF7ED3A6),
    onSecondary = Color(0xFF00391F),
    secondaryContainer = Color(0xFF1F5A3B),
    onSecondaryContainer = KushaColors.MintSoft,
    tertiary = KushaColors.Jar,
    background = KushaColors.PaperDark,
...
@Composable
fun KushaTheme(dark: Boolean = isSystemInDarkTheme(), content: @Composable () -> Unit) {
