...
val JA = Strings(
    ...
    about = "Kusha について", aboutBody = "ゲームループ型タスク管理。タスクを 2〜5 分に分解し、完了したらくしゃっと丸めて瓶へ。MIT License / OSS。",
...
val EN = Strings(
    ...
    about = "About Kusha", aboutBody = "Game-loop task manager. Break tasks into 2–5 minute pieces, crumple them when done, and watch the jar fill up. MIT License / OSS.",
