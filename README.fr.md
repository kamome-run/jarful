...
Largeur de papier : **58 mm (384 points)** ou **80 mm (576 points)**. La **densité d'impression** (1–5, 4 par défaut) fonce une impression pâle. Sur les imprimantes de poche sans massicot, laissez **Cut désactivé** ; 3 à 5 lignes d'avance papier conviennent.
